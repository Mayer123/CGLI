...
def offcial_eval(answers_file: str, predictions_file: str, output_file=None, diagnostics_file=None, sentences_file=None):
    ...
    if diagnostics:
        diagnostics.close()
    return round(evaluation.overall.F1(), 3)
...
if __name__ == '__main__':
    ...
    offcial_eval(args.answers_file, args.predictions_file, args.output_file, args.diagnostics_file, args.sentences_file)
